...
export default {
  ...
  async mounted() {
    ...
    $cookies.set("CloudFront-Signature", cookies["CloudFront-Signature"], null, "/", "playjoko.com");
    $cookies.set("CloudFront-Policy", cookies["CloudFront-Policy"], null, "/", "playjoko.com");
